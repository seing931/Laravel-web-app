    ...
    <table id="TDeptList" class="table table-hover table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="dt-font"><?php echo e($dept->deptcode); ?></td>
                <td class="dt-font"><?php echo e($dept->deptdesc); ?></td>
                <td class="text-center">
                    <a href="<?php echo e(route('dept.edit', $dept->id)); ?>" class="text-primary">
...
<?php echo $__env->make('components.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USER\Desktop\php\Herd\DPMO\resources\views/maintenance/dept.blade.php ENDPATH**/ ?>