...
<html lang="en">
    ...
    <body class="white-content {{ $class ?? '' }}">
        @auth()
            <div class="wrapper">
                    @include('components.navbars.sidebar', ['menus' => App\Http\Controllers\HomeController::getMenus()])
        ...
        @endauth
        <script src="{{ Vite::asset('resources/js/core/jquery.min.js') }}"></script>
        ...
        <script src="{{ Vite::asset('resources/js/plugins/perfect-scrollbar.jquery.min.js') }}"></script>
        <!--  Google Maps Plugin    -->
        ...
        <script src="{{ Vite::asset('resources/js/plugins/bootstrap-notify.js') }}"></script>

        <script src="{{ Vite::asset('resources/js/white-dashboard.min.js?v=1.0.0') }}"></script>
